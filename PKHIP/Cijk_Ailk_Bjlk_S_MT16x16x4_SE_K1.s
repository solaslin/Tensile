...
.text
.protected Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1
.globl Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1
.p2align 8
.type Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1
  .amdhsa_user_sgpr_kernarg_segment_ptr 1
  .amdhsa_next_free_vgpr 28 // vgprs
  .amdhsa_next_free_sgpr 102 // sgprs
  .amdhsa_group_segment_fixed_size 1636 // lds bytes
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1
    .symbol: 'Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_S_MT16x16x4_SE_K1:
...
/******************************************/
.macro MAC_2x2_X0
v_mac_f32 v[vgprValuC+0+0*2], v[vgprValuA_X0_I0+0], v[vgprValuB_X0_I0+0]
s_setprio 1 // Raise priority while processing macs
v_mac_f32 v[vgprValuC+1+0*2], v[vgprValuA_X0_I0+1], v[vgprValuB_X0_I0+0]
v_mac_f32 v[vgprValuC+0+1*2], v[vgprValuA_X0_I0+0], v[vgprValuB_X0_I0+1]
v_mac_f32 v[vgprValuC+1+1*2], v[vgprValuA_X0_I0+1], v[vgprValuB_X0_I0+1]
...
s_cmp_eq_u32 s[sgprSerialWorkGroupIter], 0  // at last iteration?
s_cbranch_scc0 label_0023                   // end kernel if not first WG
...
s_mov_b32 s70, 16                                  // LSU offset: stirde = MT0(16) + PAD0(0)
...
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  4,  6, 16 // gROA_0_0_0_0


/* global read addresses: final offsets b */

GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  5,  7, 16 // gROB_0_0_0_0
...
v_mul_u32_u24 v[vgprLocalWriteAddrA], 0x10, v1     // lwAL**(MTA + PAD)
...
/* initC: remove AB-tile 4-10 from pool */
...
v_xor_b32 v[vgprLocalWriteAddrA+0], 0x200, v[vgprLocalWriteAddrA+0] // swap Red Blk


/* local write swap b */

v_xor_b32 v[vgprLocalWriteAddrB+0], 0x200, v[vgprLocalWriteAddrB+0] // swap Red Blk
...
/* local read a */
ds_read_b32 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:64 // L -> Reg lro=16 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:96 // L -> Reg lro=16 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
/* local read a */
ds_read_b32 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:192 // L -> Reg lro=48 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:224 // L -> Reg lro=48 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
v_xor_b32 v[vgprLocalReadAddrA], 0x200, v[vgprLocalReadAddrA] // swap Red Blk

/* local read swap offsets b */
v_xor_b32 v[vgprLocalReadAddrB], 0x200, v[vgprLocalReadAddrB] // swap Red Blk
...
/* localReadInitPointers */
s_waitcnt lgkmcnt(0)                               // 6wait for local read old=2 new=0 (Local write no wait)
MAC_2x2_X0
...
/* LVCA = 16 */
/* v16 = (local)groA-tile = serial%LVCA (note (wgA*MTA) will be added to SRD) */
/* v17 = groA-unroll = serial/LVCA */
...
/* LVCB = 16 */
/* v18 = (local)groB-tile = serial%LVCB (note (wgB*MTB) will be added to SRD) */
/* v19 = groB-unroll = serial/LVCB */
...
v_mov_b32 v20, v16                                 // groA0I_0


/* global read addresses: tile offsets b */

v_mov_b32 v21, v18                                 // groB1J_0


/* global read addresses: unroll offsets a */

v_mov_b32 v22, v17                                 // groAL_0


/* global read addresses: unroll offsets b */

v_mov_b32 v23, v19                                 // groBL_0


/* global read addresses: final offsets a */

GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0, 20, 22, 24 // gROA_0_0_0_0


/* global read addresses: final offsets b */

GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 21, 23, 24 // gROB_0_0_0_0
...
/* lwaTileAssignmentA = v16 */

/* lwaTileAssignmentB = v18 */

/* lwaUnrollAssignmentA = v17 */
...
v_mul_u32_u24 v[vgprLocalWriteAddrA], 0x10, v17    // lwAL**(MTA + PAD)
_v_add_lshl_u32 v[vgprLocalWriteAddrA], v16, v[vgprLocalWriteAddrA], 0x2 // lwFOA = (lwAA + lwAL*(MT0I+PAD))*bpe


/* local write addresses: first offset b */

v_mul_u32_u24 v[vgprLocalWriteAddrB], 0x10, v19    // lwBL**(MTB + PAD)
_v_add_lshl_u32 v[vgprLocalWriteAddrB], v18, v[vgprLocalWriteAddrB], 0x2 // lwFOB = (lwBB + lwBL*(MT1J+PAD))*bpe
_v_add_co_u32 v[vgprLocalWriteAddrB], vcc, 0x100, v[vgprLocalWriteAddrB] // lwFOB = lwB1J + lwBL*MT1J + LDS_OFFSET_B=64*4
...
v_and_b32 v[vgprLocalWriteAddrA], 0xf001ff, v[vgprLocalWriteAddrA] // reset to Red


/* local write reset offsets b */

v_and_b32 v[vgprLocalWriteAddrB], 0xf001ff, v[vgprLocalWriteAddrB] // reset to Red
...
/* handled internally */
v_and_b32 v[vgprLocalReadAddrA], 0x1ff, v[vgprLocalReadAddrA] // reset Red,Blk -> Red
...
/* localReadResetOffsets */
/* handled internally */
v_and_b32 v[vgprLocalReadAddrB], 0x1ff, v[vgprLocalReadAddrB] // reset Red,Blk -> Red
...
_v_add_co_u32 v[vgprLocalReadAddrA], vcc, s70, v[vgprLocalReadAddrA] // lrA += 64 (LSU*(MT+PAD)*bpe)
...
Summation_End_14:
/* endSummation: add vgpr [4...14) to pool */
...
/* computeStoreVgprs */
v_lshrrev_b32 v5, 3, v[vgprSerial]                 // v5 = v[vgprSerial] / 8
v_and_b32 v4, 7, v[vgprSerial]                     // v4 = v[vgprSerial] % 8
v_mul_lo_u32 v6, v5, s[sgprStrideC1J]              // rowStart vgpr

s_mul_i32 s70, 0x10, s[sgprPrevWorkGroup0]         // s70 = wg0*MT0
_v_add_co_u32 v4, vcc, s70, v4                     // coord0 = tid0*VW + wg0*MT0
s_mul_i32 s72, 0x10, s[sgprPrevWorkGroup1]         // <- wg1*MT1
_v_add_co_u32 v5, vcc, s72, v5                     // coord1 = tid1*VW + wg1*MT1
...
_v_add_lshl_u32 v9, v6, v4, 0x2                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=4, coord0Vgpr=4
...
buffer_store_dword v0, v9, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v1, v9, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:32 // store D
...
buffer_store_dword v2, v9, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v3, v9, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:32 // store D
...
/* calc coords, apply mask, and issue loads (if necessary) */
/* (d1,vc1,d0,vc0)=(0,0,0,0) */
v_cmp_lt_u32 s[70:71], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v5, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[76:77], s[70:71], s[76:77]             // in0 && in1
_v_add_lshl_u32 v9, v6, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v9, -1, v9, s[76:77]                 // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
_v_add_co_u32 v7, vcc, v4, 8                       // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[70:71], v7, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[78:79], v5, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[78:79], s[70:71], s[78:79]             // in0 && in1
_v_add_lshl_u32 v10, v6, v7, 0x2                   // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, -1, v10, s[78:79]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
_v_add_co_u32 v5, vcc, v5, 8                       // coord1.1: coord1Vgpr += d1*sg1*VW + vc1

/* Fix for UseInitialStridesCD, emitAddressSetupCode */
s_mul_i32 s70, s[sgprStrideC1J], 8                 // scale stride
_v_add_u32 v6, v6, s70                             // ROWINC- Move cinRowPtr to next row
v_cmp_lt_u32 s[70:71], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[80:81], v5, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[80:81], s[70:71], s[80:81]             // in0 && in1
_v_add_lshl_u32 v11, v6, v4, 0x2                   // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v11, -1, v11, s[80:81]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,1,0) */
_v_add_co_u32 v7, vcc, v4, 8                       // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[70:71], v7, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[82:83], v5, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[82:83], s[70:71], s[82:83]             // in0 && in1
_v_add_lshl_u32 v12, v6, v7, 0x2                   // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v12, -1, v12, s[82:83]               // clip if OOB. offset
...
/* apply mask, calc new C and issue writes */
buffer_store_dword v0, v9, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v1, v10, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v2, v11, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v3, v12, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
s_branch label_0022                                // jump to end
label_0022:
