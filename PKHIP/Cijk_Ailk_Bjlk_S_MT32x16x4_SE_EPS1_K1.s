...
.text
.protected Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1
.globl Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1
.p2align 8
.type Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1
    .symbol: 'Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_S_MT32x16x4_SE_EPS1_K1:
...
.set sgprEvenIterStart, 7
.set sgprTailLoopCounter, 8
.set sgprSrdA, 12
.set sgprSrdB, 16
.set sgprSrdD, 20
.set sgprSrdC, 24
.set sgprTensor2dSizeA, 28
.set sgprTensor2dSizeB, 30
.set sgprAddressD, 32
.set sgprAddressC, 34
.set sgprAddressA, 36
.set sgprAddressB, 38
...
.set sgprStridesA, 45
.set sgprStridesB, 47
.set sgprSizesFree, 49
.set sgprSizesSum, 52
.set sgprOrigStaggerUIter, 53
.set sgprNumWorkGroups0, 54
.set sgprNumWorkGroups1, 55
.set sgprMagicNumberProblemNumGroupTiles0, 56
.set sgprGridNumWorkGroups0, 57
...
.set sgprWrapUA, 41
.set sgprWrapUB, 64
.set sgprSerialWorkGroupIter, 61
.set sgprPrevWorkGroup0, 66
.set sgprPrevWorkGroup1, 67
...
/* Load Kernel Args */
s_load_dwordx16 s[28:43], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x8 // 
s_load_dwordx16 s[44:59], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x48 // 
...
s_mov_b32 s[sgprEvenIterStart], 0                  // init SerialWorkGroupIter
...
s_mov_b32 s71, 32                                  // LSU offset: stirde = MT0(32) + PAD0(0)
...
v_lshrrev_b32 v0, 6, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(64)
s_mov_b32 s71, 16                                  // LSU offset: stirde = MT1(16) + PAD1(0)
...
s_mul_hi_u32 s73, s[sgprSerialWorkGroupIter], s[sgprMagicNumberProblemNumGroupTiles0] // s_magic mul
s_mul_i32 s72, s[sgprSerialWorkGroupIter], s[sgprMagicNumberProblemNumGroupTiles0] // s_magic mul
...
s_cselect_b32 s74, s[sgprWgmRemainder1], 8         // 
...
s_mul_i32 s72, s72, 8                              // blockId * WGM
...
ds_read_b32 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:64 // L -> Reg lro=16 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuB_X0_I0+1], v[vgprLocalReadAddrB] offset:96 // L -> Reg lro=16 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
/* local read a */
ds_read_b32 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:256 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:288 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:320 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=1 iui=0
buffer_load_dword v[vgprG2LA+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_0_0
buffer_load_dword v[vgprG2LA+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_1_0
buffer_load_dword v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0, offen offset:0 // G -> Reg 0_0_0_0
...
s_cmp_eq_u32 s[sgprShadowLimitA+1], 0              // are we within 2^32?
s_cmov_b32 s[sgprSrdA+2], s[sgprShadowLimitA+0]    // Move shadow to real if we are within 2^32
ds_read_b32 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:352 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=1 iui=0
...
/* local read b */
ds_read_b32 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:192 // L -> Reg lro=48 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuB_X0_I0+1], v[vgprLocalReadAddrB] offset:224 // L -> Reg lro=48 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:1024 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 1024
...
/* local read a */
ds_read_b32 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:512 // L -> Reg lro=128 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:544 // L -> Reg lro=128 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:576 // L -> Reg lro=128 swapByteOffset=0 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:608 // L -> Reg lro=128 swapByteOffset=0 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=1 iui=0

/* local read b */
ds_read_b32 v[vgprValuB_X1_I0+0], v[vgprLocalReadAddrB] offset:256 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuB_X1_I0+1], v[vgprLocalReadAddrB] offset:288 // L -> Reg lro=64 swapByteOffset=0 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
/* sched write - iter 2 writesPerItem=1 */
s_waitcnt vmcnt(1)                                 // wait for global read before writing to local
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+1] offset:1280 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1280
/* sched write - iter 2 writesPerItem=1 */
s_waitcnt vmcnt(0)                                 // wait for global read before writing to local
ds_write_b32 v[vgprLocalWriteAddrB], v[vgprG2LB+0] offset:1024 // lwoB_0_0_0_0 = (0*LSCB) + (0*LSPB)(*MT1J+PAD) = 1024
...
/* local read swap internal offset -> 1024 */
...
/* local read a */
ds_read_b32 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:1024 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:1056 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+2], v[vgprLocalReadAddrA] offset:1088 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+3], v[vgprLocalReadAddrA] offset:1120 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=0 iui=0

/* local read b */
ds_read_b32 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:1024 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuB_X0_I0+1], v[vgprLocalReadAddrB] offset:1056 // L -> Reg lro=0 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
/* local read a */
ds_read_b32 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:1152 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:1184 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:1216 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=1 iui=0
buffer_load_dword v[vgprG2LA+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_0_0
buffer_load_dword v[vgprG2LA+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_1_0
buffer_load_dword v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0, offen offset:0 // G -> Reg 0_0_0_0
...
s_cmp_eq_u32 s[sgprShadowLimitA+1], 0              // are we within 2^32?
s_cmov_b32 s[sgprSrdA+2], s[sgprShadowLimitA+0]    // Move shadow to real if we are within 2^32
ds_read_b32 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:1248 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=1 iui=0

/* local read b */
ds_read_b32 v[vgprValuB_X1_I0+0], v[vgprLocalReadAddrB] offset:1088 // L -> Reg lro=16 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuB_X1_I0+1], v[vgprLocalReadAddrB] offset:1120 // L -> Reg lro=16 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
...
/* local read a */
ds_read_b32 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:1280 // L -> Reg lro=64 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:1312 // L -> Reg lro=64 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuA_X0_I0+2], v[vgprLocalReadAddrA] offset:1344 // L -> Reg lro=64 swapByteOffset=1024 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=0 iui=0
...
s_cmp_eq_u32 s[sgprShadowLimitB+1], 0              // are we within 2^32?
s_cmov_b32 s[sgprSrdB+2], s[sgprShadowLimitB+0]    // Move shadow to real if we are within 2^32
ds_read_b32 v[vgprValuA_X0_I0+3], v[vgprLocalReadAddrA] offset:1376 // L -> Reg lro=64 swapByteOffset=1024 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=0 iui=0

/* local read b */
ds_read_b32 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:1152 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_b32 v[vgprValuB_X0_I0+1], v[vgprLocalReadAddrB] offset:1184 // L -> Reg lro=32 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=0 iui=0
...
/* local read a */
ds_read_b32 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:1408 // L -> Reg lro=96 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:1440 // L -> Reg lro=96 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:1472 // L -> Reg lro=96 swapByteOffset=1024 ti=8 vIdx=2 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:1504 // L -> Reg lro=96 swapByteOffset=1024 ti=8 vIdx=3 rIdx=0 oIdx=0 buffer=1 iui=0

/* local read b */
ds_read_b32 v[vgprValuB_X1_I0+0], v[vgprLocalReadAddrB] offset:1216 // L -> Reg lro=48 swapByteOffset=1024 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_read_b32 v[vgprValuB_X1_I0+1], v[vgprLocalReadAddrB] offset:1248 // L -> Reg lro=48 swapByteOffset=1024 ti=8 vIdx=1 rIdx=0 oIdx=0 buffer=1 iui=0
/* sched write - iter 2 writesPerItem=1 */
s_waitcnt vmcnt(1)                                 // wait for global read before writing to local
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+1] offset:256 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 256
/* sched write - iter 2 writesPerItem=1 */
...
s_mul_i32 s71, s[sgprNumWorkGroups0], s[sgprNumWorkGroups1] // Total WG
s_cmp_ge_u32 s[sgprSerialWorkGroupIter], s71       // outside legal WG?
s_cbranch_scc1 label_0013                          // skip pf if OOB
...
s_lshr_b32 s[sgprLoopCounterL], s[sgprSizesSum+0], 2 // s[sgprLoopCounterL] = s[sgprSizesSum+0] / 4
s_mov_b32 s[sgprOrigLoopCounter], s[sgprLoopCounterL] // copy loop counter
s_and_b32 s[sgprEvenIterStart], s[sgprOrigLoopCounter], 1 // save unroll loop start position - copy1 or copy2
...
s_cmp_eq_u32 s[sgprLoopCounterL], 0                // at last iteration?
s_cbranch_scc1 label_0013                          // skip prefetch loads since numIter==0
...
label_0013:  /// SkipPrefetchAcrossPersistent
...
_v_add_co_u32 v[vgprLocalReadAddrB], vcc, s71, v[vgprLocalReadAddrB] // lrB += 64 (LSU*(MT+PAD)*bpe)
...
s_mov_b32 s71, 128                                 // tailloop lds offset
s_mul_i32 s71, s[sgprOrigLoopCounter], s71         // scale by mul
v_sub_u32 v[vgprLocalReadAddrA], v[vgprLocalReadAddrA], s71 // remove lro damage
s_mov_b32 s71, 64                                  // tailloop lds offset
s_mul_i32 s71, s[sgprOrigLoopCounter], s71         // scale by mul
v_sub_u32 v[vgprLocalReadAddrB], v[vgprLocalReadAddrB], s71 // remove lro damage
label_0006:
...
s_mul_i32 s72, 0x20, s[sgprPrevWorkGroup0]         // s72 = wg0*MT0
_v_add_co_u32 v8, vcc, s72, v8                     // coord0 = tid0*VW + wg0*MT0
s_mul_i32 s74, 0x10, s[sgprPrevWorkGroup1]         // <- wg1*MT1
_v_add_co_u32 v9, vcc, s74, v9                     // coord1 = tid1*VW + wg1*MT1
...
s_cmp_ge_u32 s[sgprPrevWorkGroup0], s74            // wg0 >= nwg0-1 ?
...
s_cmp_ge_u32 s[sgprPrevWorkGroup1], s74            // wg1 >= nwg1-1
...
s_mul_i32 s72, s[sgprStrideD1J], 32                // scale StrideD *= numRows(8) * bpe
...
/* edge=1, allocate 30 sgpr. perBatch=6 perElement=2 elementsPerBatch=12 */
