...
.text
.protected Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0
.globl Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0
.p2align 8
.type Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0
  .amdhsa_user_sgpr_kernarg_segment_ptr 1
  .amdhsa_next_free_vgpr 25 // vgprs
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0
    .symbol: 'Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP0:
...
v_lshrrev_b32 v0, 6, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(64)
s_mov_b32 s67, 16                                  // LSU offset: stirde = MT1(16) + PAD1(0)
...
s_lshl_b64 s[70:71], s[70:71], 2                   // tileStart *= BPE
...
s_and_b32 s69, 3, s[sgprSizesSum+0]                // s69 = s[sgprSizesSum+0] % 4
...
_v_add_co_u32 v14, vcc, s68, v14                   // coord0 = tid0*VW + wg0*MT0
s_mul_i32 s70, 0x10, s[sgprWorkGroup1]             // <- wg1*MT1
_v_add_co_u32 v15, vcc, s70, v15                   // coord1 = tid1*VW + wg1*MT1
...
s_mul_i32 s68, s[sgprStrideD1J], 32                // scale StrideD *= numRows(8) * bpe
...
s_mul_i32 s67, s[sgprNumWorkGroups0], s[sgprNumWorkGroups1] // Total WG
...
s_mov_b32 s67, 0x80                                // inc
_v_add_co_u32 v[vgprLocalReadAddrA], vcc, s67, v[vgprLocalReadAddrA] // lrA += 128 (LSU*(MT+PAD)*bpe)
...
s_mov_b32 s67, 128                                 // tailloop lds offset
...
/* edge=1, allocate 24 sgpr. perBatch=6 perElement=2 elementsPerBatch=9 */
...
v_cndmask_b32 v16, -1, v16, s[80:81]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
_v_add_co_u32 v9, vcc, v9, 8                       // coord1.1: coord1Vgpr += d1*sg1*VW + vc1

/* Fix for UseInitialStridesCD, emitAddressSetupCode */
s_mul_i32 s68, s[sgprStrideC1J], 8                 // scale stride
...
v_cndmask_b32 v17, -1, v17, s[82:83]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,1,0) */
_v_add_co_u32 v11, vcc, v8, 8                      // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[68:69], v11, s[sgprSizeI]           // coord0 < size0
...
v_cndmask_b32 v18, -1, v18, s[84:85]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,2,0) */
_v_add_co_u32 v11, vcc, v8, 16                     // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[68:69], v11, s[sgprSizeI]           // coord0 < size0
...
v_cndmask_b32 v19, -1, v19, s[86:87]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,3,0) */
_v_add_co_u32 v11, vcc, v8, 24                     // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[68:69], v11, s[sgprSizeI]           // coord0 < size0
...
v_cndmask_b32 v20, -1, v20, s[88:89]               // clip if OOB. offset
