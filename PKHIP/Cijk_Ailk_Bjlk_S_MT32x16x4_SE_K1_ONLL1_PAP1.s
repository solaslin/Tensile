...
.text
.protected Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1
.globl Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1
.p2align 8
.type Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1
  .amdhsa_user_sgpr_kernarg_segment_ptr 1
  .amdhsa_next_free_vgpr 37 // vgprs
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1
    .symbol: 'Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_S_MT32x16x4_SE_K1_ONLL1_PAP1:
...
.set vgprG2LB, 21
.set vgprLocalWriteAddrA, 14
.set vgprLocalWriteAddrB, 15
...
/* initC: remove AB-tile 8-14 from pool */
...
/* localReadInitPointers */
s_waitcnt lgkmcnt(0)                               // 6wait for local read old=3 new=0 (Local write no wait)
MAC_4x2_X0
...
/* LVCA = 32 */
/* v24 = (local)groA-tile = serial%LVCA (note (wgA*MTA) will be added to SRD) */
/* v25 = groA-unroll = serial/LVCA */
v_lshrrev_b32 v25, 5, v[vgprSerial]                // v25 = v[vgprSerial] / 32
...
/* LVCB = 16 */
/* v26 = (local)groB-tile = serial%LVCB (note (wgB*MTB) will be added to SRD) */
/* v27 = groB-unroll = serial/LVCB */
v_lshrrev_b32 v27, 4, v[vgprSerial]                // v27 = v[vgprSerial] / 16
v_and_b32 v26, 15, v[vgprSerial]                   // v26 = v[vgprSerial] % 16
...
v_mov_b32 v28, v24                                 // groA0I_0


/* global read addresses: tile offsets b */

v_mov_b32 v29, v26                                 // groB1J_0


/* global read addresses: unroll offsets a */

v_mov_b32 v30, v25                                 // groAL_0
_v_add_co_u32 v31, vcc, 2, v30                     // groAL_1 + LSPA


/* global read addresses: unroll offsets b */

v_mov_b32 v32, v27                                 // groBL_0


/* global read addresses: final offsets a */

GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0, 28, 30, 33 // gROA_0_0_0_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1, 28, 31, 33 // gROA_0_0_1_0


/* global read addresses: final offsets b */

GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 29, 32, 33 // gROB_0_0_0_0
...
/* lwaTileAssignmentA = v24 */

/* lwaTileAssignmentB = v26 */

/* lwaUnrollAssignmentA = v25 */

/* lwaUnrollAssignmentB = v27 */


/* local write addresses: first offset a */

v_mul_u32_u24 v[vgprLocalWriteAddrA], 0x20, v25    // lwAL**(MTA + PAD)
_v_add_lshl_u32 v[vgprLocalWriteAddrA], v24, v[vgprLocalWriteAddrA], 0x2 // lwFOA = (lwAA + lwAL*(MT0I+PAD))*bpe


/* local write addresses: first offset b */

v_mul_u32_u24 v[vgprLocalWriteAddrB], 0x10, v27    // lwBL**(MTB + PAD)
_v_add_lshl_u32 v[vgprLocalWriteAddrB], v26, v[vgprLocalWriteAddrB], 0x2 // lwFOB = (lwBB + lwBL*(MT1J+PAD))*bpe
_v_add_co_u32 v[vgprLocalWriteAddrB], vcc, 0x200, v[vgprLocalWriteAddrB] // lwFOB = lwB1J + lwBL*MT1J + LDS_OFFSET_B=128*4
...
s_and_b32 s71, 3, s[sgprSizesSum+0]                // s71 = s[sgprSizesSum+0] % 4
s_cmp_eq_u32 s71, 0x0                              // numIterL == 0
s_cbranch_scc0 OptNLL_End_13                       // skip if tail loop required

/* reclaim VGPRS: 19-20, 14, 21, 15, 16-18 */
...
/* Stores for OptNLL */
/* computeStoreVgprs */
v_lshrrev_b32 v15, 3, v[vgprSerial]                // v15 = v[vgprSerial] / 8
v_and_b32 v14, 7, v[vgprSerial]                    // v14 = v[vgprSerial] % 8
v_mul_lo_u32 v16, v15, s[sgprStrideC1J]            // rowStart vgpr

s_mul_i32 s70, 0x20, s[sgprPrevWorkGroup0]         // s70 = wg0*MT0
_v_add_co_u32 v14, vcc, s70, v14                   // coord0 = tid0*VW + wg0*MT0
s_mul_i32 s72, 0x10, s[sgprPrevWorkGroup1]         // <- wg1*MT1
_v_add_co_u32 v15, vcc, s72, v15                   // coord1 = tid1*VW + wg1*MT1
_v_add_lshl_u32 v17, v16, v14, 0x2                 // NLL: init cb addr <-  cinRowStart + coord0, scaled by BPE

/* store element 0 : (0, 0, 0, 0) */
/* (d1,vc1,d0,vc0)=(0,0,0,0) */
_v_add_lshl_u32 v17, v16, v14, 0x2                 // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=14, coord0Vgpr=14
buffer_store_dword v0, v17, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D

/* store element 1 : (0, 1, 0, 0) */
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
buffer_store_dword v1, v17, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:32 // store D
...
buffer_store_dword v3, v17, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:96 // store D
...
buffer_store_dword v5, v17, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:32 // store D
...
buffer_store_dword v7, v17, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:96 // store D
...
Summation_End_14:
/* endSummation: add vgpr [8...19) to pool */
...
_v_add_lshl_u32 v24, v10, v11, 0x2                 // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v24, -1, v24, s[88:89]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,3,0) */
_v_add_co_u32 v11, vcc, v8, 24                     // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[70:71], v11, s[sgprSizeI]           // coord0 < size0
v_cmp_lt_u32 s[90:91], v9, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[90:91], s[70:71], s[90:91]             // in0 && in1
_v_add_lshl_u32 v25, v10, v11, 0x2                 // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v25, -1, v25, s[90:91]               // clip if OOB. offset
...
buffer_store_dword v6, v24, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
buffer_store_dword v7, v25, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0 // store D
s_branch label_0023                                // jump to end
label_0023:
