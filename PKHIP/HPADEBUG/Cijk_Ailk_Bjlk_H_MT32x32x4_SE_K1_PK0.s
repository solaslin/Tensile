...
.text
.protected Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0
.globl Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0
.p2align 8
.type Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0
    .symbol: 'Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_H_MT32x32x4_SE_K1_PK0:
...
v_cmp_lt_u32 s[52:53], v10, v8                     // wgMT < MT
v_cndmask_b32 v10, v8, v10, s[52:53]               // wgMT = (wgMT < MT) ? wgMT : MT
...
v_cmp_eq_u32 s[52:53], v20, v15                    // mask
v_mov_b32 v8, s52                                  // 
v_mov_b32 v9, s53                                  // 
...
/* shift d1 r=1 v=0 */
label_0013:
_v_cmpx_eq_u32 s[52:53], v20, v15                  // serial % SG == (wgMT/VECTOR_WIDTH)%SG
// src=4, dst=0
// 1, 0, 0, 0, 0, 4
...
_v_add_co_u32 v8, vcc, s52, v8                     // coord0 = tid0*VW + wg0*MT0
s_mul_i32 s54, 0x20, s[sgprWorkGroup1]             // <- wg1*MT1
_v_add_co_u32 v9, vcc, s54, v9                     // coord1 = tid1*VW + wg1*MT1
...
v_cmp_lt_u32 s[58:59], v9, s[sgprSizeJ]            // coord1 < size1
...
v_cndmask_b32 v13, -1, v13, s[58:59]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
_v_add_co_u32 v11, vcc, v8, 16                     // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[52:53], v11, s[sgprSizeI]           // coord0 < size0
...
v_cndmask_b32 v14, -1, v14, s[60:61]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
...
v_cndmask_b32 v19, -1, v19, s[64:65]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
_v_add_co_u32 v9, vcc, v9, 15                      // coord1.1: coord1Vgpr += d1*sg1*VW + vc1

/* Fix for UseInitialStridesCD, emitAddressSetupCode */
s_mul_i32 s52, s[sgprStrideC1J], 15                // scale stride
_v_add_u32 v10, v10, s52                           // ROWINC- Move cinRowPtr to next row
v_cmp_lt_u32 s[52:53], v8, s[sgprSizeI]            // coord0 < size0
...
v_cndmask_b32 v20, -1, v20, s[66:67]               // clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,1,0) */
_v_add_co_u32 v11, vcc, v8, 16                     // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[52:53], v11, s[sgprSizeI]           // coord0 < size0
