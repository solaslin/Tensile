...
.text
.protected Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1
.globl Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1
.p2align 8
.type Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1
    .symbol: 'Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_BH_MT64x64x32_MI32x32x4x1_SE_K1:
...
s_sub_u32 s57, s57, 8                              // edge -= margin
v_mov_b32 v8, s57                                  // edge vgpr = Size1J-8
...
v_cndmask_b32 v[vgprValuC+11], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+12], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+13], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+14], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+19], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+20], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+21], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+22], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+23], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+24], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+25], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+26], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+27], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+28], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+29], v31, v33, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+30], v31, v33, s[52:53]  // 
...
s_mov_b32 s57, 0x200                               // inc
_v_add_co_u32 v[vgprLocalReadAddrA], vcc, s57, v[vgprLocalReadAddrA] // lrA += 512 (LSU*(MT+PAD)*bpe)


/* local read inc b */

s_mov_b32 s57, 0x200                               // inc
_v_add_co_u32 v[vgprLocalReadAddrB], vcc, s57, v[vgprLocalReadAddrB] // lrB += 512 (LSU*(MT+PAD)*bpe)
...
v_cndmask_b32 v[vgprValuC+11], v33, v35, s[52:53]  // 
v_lshrrev_b32 v[vgprValuC+11], 16, v[vgprValuC+11] // convert C to bf16
v_cmp_u_f32 s[52:53], v[vgprValuC+12], v[vgprValuC+12] // check Nan
...
v_cndmask_b32 v[vgprValuC+12], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+13], v33, v35, s[52:53]  // 
v_lshrrev_b32 v[vgprValuC+13], 16, v[vgprValuC+13] // convert C to bf16
v_cmp_u_f32 s[52:53], v[vgprValuC+14], v[vgprValuC+14] // check Nan
...
v_cndmask_b32 v[vgprValuC+14], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+19], v33, v35, s[52:53]  // 
v_lshrrev_b32 v[vgprValuC+19], 16, v[vgprValuC+19] // convert C to bf16
v_cmp_u_f32 s[52:53], v[vgprValuC+20], v[vgprValuC+20] // check Nan
...
v_cndmask_b32 v[vgprValuC+20], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+21], v33, v35, s[52:53]  // 
v_lshrrev_b32 v[vgprValuC+21], 16, v[vgprValuC+21] // convert C to bf16
v_cmp_u_f32 s[52:53], v[vgprValuC+22], v[vgprValuC+22] // check Nan
...
v_cndmask_b32 v[vgprValuC+22], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+24], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+25], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+26], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+27], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+29], v33, v35, s[52:53]  // 
v_lshrrev_b32 v[vgprValuC+29], 16, v[vgprValuC+29] // convert C to bf16
v_cmp_u_f32 s[52:53], v[vgprValuC+30], v[vgprValuC+30] // check Nan
...
v_cndmask_b32 v[vgprValuC+30], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+31], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v[vgprValuC+32], v33, v35, s[52:53]  // 
...
v_cndmask_b32 v21, -1, v21, s[54:55]               // clip if OOB. offset
